...
import { M3_R8_OUTPUT_PATHS, executeR8Authoritative, existingR8OutputArtifacts } from "../src/lib/research/m3-r8-round-008-performance.ts";
...
if (M3_R8_OUTPUT_PATHS.some((relative) => existsSync(relative)) || existingR8OutputArtifacts().length > 0) throw new Error("R8 output unexpectedly exists during import smoke.");
