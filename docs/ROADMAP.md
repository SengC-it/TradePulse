...
M3-R3-C is authorized for the separate mechanical selection gate application;
no Round-003 selection result has been generated yet. M3-J is blocked, and M4
is not started. See
...
gates, freeze `baseline-002`, start M3-J, or start M4. The authoritative
selection command is deferred until the Commit-A CI succeeds.
