...
import { M3_R5_ROUND_005_SELECTION_GATES } from "../src/lib/research/selection-gates-round-005.ts";
import {
...
describe("M3-R6-B.1B final registry, Gate, and Plan freeze", () => {
  ...
  it("reproduces the canonical Gate and Plan hashes", () => {
    ...
    expect(M3_R6_ROUND_006_PLAN_SHA256).toBe("86dc1b341c7f34fed8f80dc54b54741b19576bbc5d898b2a0e95884b19184fa6");
  });
