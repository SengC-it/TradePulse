...
import { R11_MAX_STOP_ATR, R11_MIN_STOP_ATR, R11_STOP_BUFFER_ATR } from "./m3-r11-round-011-risk-geometry.ts";

export const M3_R11_RESEARCH_ROUND_ID = "baseline-002-research-round-011" as const;
export const M3_R11_RESEARCH_START_ISO = "2023-01-01T00:00:00.000Z" as const;
export const M3_R11_RESEARCH_END_ISO = "2026-08-15T23:59:59.999Z" as const;
export const M3_R11_RESEARCH_RANGE = Object.freeze({
  startTime: Date.parse(M3_R11_RESEARCH_START_ISO),
  endTime: Date.parse(M3_R11_RESEARCH_END_ISO),
  classification: "RESEARCH_AVAILABLE_SEEN_DATA",
} as const);
export const M3_R11_PROTOCOL_VERSION = "m3-r11-round-011-spec-conformance-replay-001" as const;
export const M3_R11_PERFORMANCE_LOCK = "FIRST_M3_R11_PERFORMANCE_RESULT_GENERATED" as const;
export const M3_R11_BASE_SOURCE_SHA = "230c9301b8324446327c1274f4ba05089a4b4f99" as const;
export const M3_R11_CONTROL_ID = "R11-CONTROL-BASELINE-001" as const;
export const M3_R11_POLICY_VERSION = "bt-policy-003" as const;
export const M3_R11_NO_CANDIDATE_OUTCOME = "NO BASELINE-002 CANDIDATE — ROUND-011" as const;

export const R11_SYMBOLS = Object.freeze([...RESEARCH_SYMBOLS]) as readonly ResearchSymbol[];
export const R11_FROZEN_FOLD_IDS = Object.freeze([...RESEARCH_FOLD_IDS]);
export const R11_FROZEN_FOLDS = RESEARCH_FOLDS;

export const M3_R11_CANDIDATE_IDS = Object.freeze([
  "R11-R1-REGIME-EXPECTANCY-ROUTER",
  "R11-E1-PULLBACK-RECLAIM",
  "R11-E2-BREAKOUT-RETEST",
  "R11-S1-CALIBRATED-SCORE-V2",
  "R11-C1-RECLAIM-CALIBRATED-SCORE-V2",
] as const);
export type R11CandidateId = (typeof M3_R11_CANDIDATE_IDS)[number];
export type R11Direction = "LONG" | "SHORT";

export type R11ComplexityTuple = Readonly<{
  newRules: number;
...
export type R11CandidateDefinition = Readonly<{
...
export const R11_RISK_GEOMETRY_CONTRACT = deepFreeze({
  decisionReference: "CLOSED_DECISION_CANDLE_REFERENCE_BEFORE_NEXT_CANONICAL_1H_OPEN",
  atr: "ATR14_1H_AT_DECISION_CANDLE",
  stopBufferAtr: R11_STOP_BUFFER_ATR,
  minimumStopAtr: R11_MIN_STOP_ATR,
  maximumStopAtr: R11_MAX_STOP_ATR,
...
export const R11_CANDIDATE_REGISTRY: readonly R11CandidateDefinition[] = deepFreeze<R11CandidateDefinition[]>([
  {
    candidateId: "R11-R1-REGIME-EXPECTANCY-ROUTER",
    variantId: "R11-R1-V1",
  ...
  {
    candidateId: "R11-E2-BREAKOUT-RETEST",
    variantId: "R11-E2-V1",
  ...
  {
    candidateId: "R11-S1-CALIBRATED-SCORE-V2",
    variantId: "R11-S1-V1",
  ...
  {
    candidateId: "R11-C1-RECLAIM-CALIBRATED-SCORE-V2",
    variantId: "R11-C1-V1",
    mechanismFamily: "RECLAIM_CALIBRATED_SCORE",
    kind: "COMBINED",
    parameters: { ridgeLambda: 10, minimumPredictedNetR: 0.05, featureCount: 10, upstreamEvent: "R11-E1-PULLBACK-RECLAIM" },
    signalRule: "RETAIN_R11_E1_PULLBACK_RECLAIM_OPPORTUNITIES_WHEN_THE_FOLD_LOCAL_RESEARCH_ONLY_E1_RIDGE_MODEL_PREDICTS_NET_R_AT_LEAST_0_05",
    dataRule: "R11_E1_SETTLED_OPPORTUNITY_STREAM;TEN_DECISION_TIME_CLOSED_DATA_FEATURES;RESEARCH_FIT_AND_VALIDATION_PREDICTION_ARE_SEPARATE",
    composition: "PREDECLARED_COMBINATION",
  },
]);

export const R11_COMPLEXITY_TUPLES: Readonly<Record<R11CandidateId, R11ComplexityTuple>> = deepFreeze({
  "R11-R1-REGIME-EXPECTANCY-ROUTER": { newRules: 2, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R11-E1-PULLBACK-RECLAIM": { newRules: 4, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R11-E2-BREAKOUT-RETEST": { newRules: 3, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R11-S1-CALIBRATED-SCORE-V2": { newRules: 2, newTunableThresholds: 0, modifiedBaselineRules: 1, mechanismFamiliesUsed: 1 },
  "R11-C1-RECLAIM-CALIBRATED-SCORE-V2": { newRules: 5, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 2 },
});

export const R11_FEATURE_NAMES = Object.freeze([
...
export type R11FeatureName = (typeof R11_FEATURE_NAMES)[number];

export const R11_FEATURE_DEFINITIONS = deepFreeze({
...
export const R11_ROUTER_BUCKETS = deepFreeze({
...
export const R11_DATA_CONTRACT = deepFreeze({
  provider: "binance-usdm-public",
  symbols: R11_SYMBOLS,
  timeframes: ["1h", "4h", "1m-settlement"] as const,
  researchStartIso: M3_R11_RESEARCH_START_ISO,
  researchEndIso: M3_R11_RESEARCH_END_ISO,
...
export const R11_EXECUTION_CONTRACT = deepFreeze({
...
export const R11_MODEL_CONTRACT = deepFreeze({
  ...
  featureNames: R11_FEATURE_NAMES,
  noLambdaSearch: true,
  noOptimizer: true,
});

export const R11_CENSOR_SEMANTICS = deepFreeze({
...
export const R11_GOVERNANCE = deepFreeze({
  ...
  round010ResultUse: "INVALIDATED_AFTER_PERFORMANCE_LOCK;SEEN_DIAGNOSTIC_DATA_ONLY;NOT_USED_FOR_R10_TUNING",
  baseline002Status: "NOT_FROZEN",
  m3JStatus: "BLOCKED",
  m4Status: "NOT_STARTED",
});

export const R11_PROTOCOL_MACHINE_RECORD = deepFreeze({
  protocolVersion: M3_R11_PROTOCOL_VERSION,
  researchRoundId: M3_R11_RESEARCH_ROUND_ID,
  baseSourceSha: M3_R11_BASE_SOURCE_SHA,
  sourceIdentity: {
    path: "src/lib/research/m3-r11-round-011-protocol.ts",
    sourceSha: M3_R11_BASE_SOURCE_SHA,
    identityRule: "ROUND_011_DEFINITIONS_FROZEN_FROM_AUTHORITATIVE_MAIN_BEFORE_PERFORMANCE",
  },
  ...
  features: R11_FEATURE_DEFINITIONS,
  ...
  governance: R11_GOVERNANCE,
  performanceExecutionSourceSha: null,
});

export const R11_REQUIRED_CANDLE_INTERVALS = Object.freeze({ oneHour: INTERVAL_MS["1h"], fourHour: INTERVAL_MS["4h"] });
