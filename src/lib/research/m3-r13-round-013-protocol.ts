...
export const R13_EXECUTION_ALIGNMENT = deepFreeze({
  ...
  executionMode: "ACTIONABLE_MARKET_REFERENCE",
  entry: "FIRST_CANONICAL_COMPLETE_1M_OPEN_AT_OR_AFTER_ACTIONABLE_AT",
  primaryEntry: "FIRST_COMPLETE_1M_OPEN_AT_OR_AFTER_SIGNAL_TIME_PLUS_6_MINUTES",
  stressEntry: "FIRST_COMPLETE_1M_OPEN_AT_OR_AFTER_SIGNAL_TIME_PLUS_7_MINUTES",
  validUntil: "signalTime + 60_MINUTES",
  validityContext: "60_MINUTES_AND_CANONICAL_MARKET_OPEN_MUST_BE_AVAILABLE_AT_ACTIONABLE_AT",
  productionNoEntry: "POST_BOUNDARY_DIAGNOSTIC_ONLY_NOT_BASELINE_001_HISTORICAL_SEMANTICS",
...
export const R13_FEATURE_DEFINITIONS: Readonly<Record<R13FeatureName, string>> = deepFreeze({
  ...
  F04_directionAdjustedReturn1hAtrPriceScale: "direction * 1h_symbol_return / (ATR14_1h / close1h)",
...
export const R13_DATA_CONTRACT = deepFreeze({
  ...
  observationIntegrity: "EXPECTED_WARMUP_ONLY_BEFORE_FIRST_COMPLETE_FEATURE_ELIGIBLE_TIMESTAMP;AFTER_WARMUP_FAIL_CLOSED",
