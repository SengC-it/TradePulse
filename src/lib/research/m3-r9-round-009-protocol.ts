...
export const M3_R9_RESEARCH_ROUND_ID = "baseline-002-research-round-009" as const;
export const M3_R9_RESEARCH_START_ISO = "2023-01-01T00:00:00.000Z" as const;
export const M3_R9_RESEARCH_END_ISO = "2026-08-15T23:59:59.999Z" as const;
export const M3_R9_RESEARCH_RANGE = Object.freeze({
  startTime: Date.parse(M3_R9_RESEARCH_START_ISO),
  endTime: Date.parse(M3_R9_RESEARCH_END_ISO),
  classification: "RESEARCH_AVAILABLE_SEEN_DATA",
} as const);
export const M3_R9_PROTOCOL_VERSION = "m3-r9-round-009-spec-conformance-replay-001" as const;
export const M3_R9_PERFORMANCE_LOCK = "FIRST_M3_R9_PERFORMANCE_RESULT_GENERATED" as const;
export const M3_R9_BASE_SOURCE_SHA = "230c9301b8324446327c1274f4ba05089a4b4f99" as const;
export const M3_R9_CONTROL_ID = "R9-CONTROL-BASELINE-001" as const;
export const M3_R9_POLICY_VERSION = "bt-policy-003" as const;
export const M3_R9_NO_CANDIDATE_OUTCOME = "NO BASELINE-002 CANDIDATE — ROUND-009" as const;

export const R9_SYMBOLS = Object.freeze([...RESEARCH_SYMBOLS]) as readonly ResearchSymbol[];
export const R9_FROZEN_FOLD_IDS = Object.freeze([...RESEARCH_FOLD_IDS]);
export const R9_FROZEN_FOLDS = RESEARCH_FOLDS;

export const M3_R9_CANDIDATE_IDS = Object.freeze([
  "R9-R1-REGIME-EXPECTANCY-ROUTER",
  "R9-E1-PULLBACK-RECLAIM",
  "R9-E2-BREAKOUT-RETEST",
  "R9-S1-CALIBRATED-SCORE-V2",
  "R9-C1-RECLAIM-CALIBRATED-SCORE-V2",
] as const);
export type R9CandidateId = (typeof M3_R9_CANDIDATE_IDS)[number];
export type R9Direction = "LONG" | "SHORT";

export type R9ComplexityTuple = Readonly<{
  newRules: number;
...
export type R9CandidateDefinition = Readonly<{
...
export const R9_CANDIDATE_REGISTRY: readonly R9CandidateDefinition[] = deepFreeze<R9CandidateDefinition[]>([
  {
    candidateId: "R9-R1-REGIME-EXPECTANCY-ROUTER",
    variantId: "R9-R1-V1",
  ...
  {
    candidateId: "R9-E1-PULLBACK-RECLAIM",
    variantId: "R9-E1-V1",
    ...
    dataRule: "CLOSED_1H_AND_CLOSED_4H_THROUGH_DECISION_CANDLE_ONLY;NEXT_CANONICAL_1H_OPEN_ENTRY;MIRRORED_LONG_SHORT;CANDIDATE_LOCAL_SETTLEMENT",
    composition: "SINGLE_MECHANISM",
  },
  {
    candidateId: "R9-E2-BREAKOUT-RETEST",
    variantId: "R9-E2-V1",
    ...
    dataRule: "CLOSED_1H_AND_CLOSED_4H_THROUGH_RECLAIM_CANDLE_ONLY;NEXT_CANONICAL_1H_OPEN_ENTRY;MIRRORED_LONG_SHORT;CANDIDATE_LOCAL_SETTLEMENT",
    composition: "SINGLE_MECHANISM",
  },
  {
    candidateId: "R9-S1-CALIBRATED-SCORE-V2",
    variantId: "R9-S1-V1",
  ...
  {
    candidateId: "R9-C1-RECLAIM-CALIBRATED-SCORE-V2",
    variantId: "R9-C1-V1",
    mechanismFamily: "RECLAIM_CALIBRATED_SCORE",
    kind: "COMBINED",
    parameters: { ridgeLambda: 10, minimumPredictedNetR: 0.05, featureCount: 10, upstreamEvent: "R9-E1-PULLBACK-RECLAIM" },
    signalRule: "RETAIN_R9_E1_PULLBACK_RECLAIM_OPPORTUNITIES_WHEN_THE_FOLD_LOCAL_RESEARCH_ONLY_E1_RIDGE_MODEL_PREDICTS_NET_R_AT_LEAST_0_05",
    dataRule: "R9_E1_SETTLED_OPPORTUNITY_STREAM;TEN_DECISION_TIME_CLOSED_DATA_FEATURES;RESEARCH_FIT_AND_VALIDATION_PREDICTION_ARE_SEPARATE",
    composition: "PREDECLARED_COMBINATION",
  },
]);

export const R9_COMPLEXITY_TUPLES: Readonly<Record<R9CandidateId, R9ComplexityTuple>> = deepFreeze({
  "R9-R1-REGIME-EXPECTANCY-ROUTER": { newRules: 2, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R9-E1-PULLBACK-RECLAIM": { newRules: 4, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R9-E2-BREAKOUT-RETEST": { newRules: 3, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 1 },
  "R9-S1-CALIBRATED-SCORE-V2": { newRules: 2, newTunableThresholds: 0, modifiedBaselineRules: 1, mechanismFamiliesUsed: 1 },
  "R9-C1-RECLAIM-CALIBRATED-SCORE-V2": { newRules: 5, newTunableThresholds: 0, modifiedBaselineRules: 0, mechanismFamiliesUsed: 2 },
});

export const R9_FEATURE_NAMES = Object.freeze([
...
export type R9FeatureName = (typeof R9_FEATURE_NAMES)[number];

export const R9_FEATURE_DEFINITIONS = deepFreeze({
...
export const R9_ROUTER_BUCKETS = deepFreeze({
...
export const R9_DATA_CONTRACT = deepFreeze({
  provider: "binance-usdm-public",
  symbols: R9_SYMBOLS,
  timeframes: ["1h", "4h", "1m-settlement"] as const,
  researchStartIso: M3_R9_RESEARCH_START_ISO,
  researchEndIso: M3_R9_RESEARCH_END_ISO,
...
export const R9_EXECUTION_CONTRACT = deepFreeze({
...
export const R9_MODEL_CONTRACT = deepFreeze({
  ...
  featureNames: R9_FEATURE_NAMES,
  noLambdaSearch: true,
  noOptimizer: true,
});

export const R9_CENSOR_SEMANTICS = deepFreeze({
...
export const R9_GOVERNANCE = deepFreeze({
  ...
  round008ResultUse: "INVALIDATED_AFTER_PERFORMANCE_LOCK;SEEN_DIAGNOSTIC_DATA_ONLY;NOT_USED_FOR_R9_TUNING",
  baseline002Status: "NOT_FROZEN",
  m3JStatus: "BLOCKED",
  m4Status: "NOT_STARTED",
});

export const R9_PROTOCOL_MACHINE_RECORD = deepFreeze({
  protocolVersion: M3_R9_PROTOCOL_VERSION,
  researchRoundId: M3_R9_RESEARCH_ROUND_ID,
  baseSourceSha: M3_R9_BASE_SOURCE_SHA,
  sourceIdentity: {
    path: "src/lib/research/m3-r9-round-009-protocol.ts",
    sourceSha: M3_R9_BASE_SOURCE_SHA,
    identityRule: "ROUND_009_DEFINITIONS_FROZEN_FROM_AUTHORITATIVE_MAIN_BEFORE_PERFORMANCE",
  },
  ...
  features: R9_FEATURE_DEFINITIONS,
...
export const R9_REQUIRED_CANDLE_INTERVALS = Object.freeze({ oneHour: INTERVAL_MS["1h"], fourHour: INTERVAL_MS["4h"] });
