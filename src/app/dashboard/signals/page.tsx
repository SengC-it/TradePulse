...
export default async function SignalsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="TradePulse / Delivery" title="信号发送" description="以 tp_signal_advisories 为生产事实源，查看邮件发送状态与信号参数。" />
      <section className="panel-card table-card">
        <div className="section-heading"><div><p className="eyebrow">Advisory Registry</p><h2>发送记录</h2></div><span className="section-note">最多显示最近 100 条</span></div>
