...
export default async function DetectionsPage({ searchParams }: Readonly<{ searchParams: SearchParams }>) {
  ...
  return (
    <>
      <PageHeader eyebrow="TradePulse / Observability" title="信号检测" description="记录每次 Strategy Engine 对五个币种、两个方向的 evaluation，不改变信号判断。" />
      ...
      <section className="panel-card table-card">
        <div className="section-heading"><div><p className="eyebrow">Evaluation Log</p><h2>检测记录</h2></div><span className="section-note">共 {page.total} 条 · 每页 {page.pageSize} 条</span></div>
