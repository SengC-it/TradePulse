...
export default async function PerformancePage() {
  ...
  return (
    <>
      <PageHeader eyebrow="TradePulse / Analytics" title="策略表现" description="只展示已有 authoritative resolved result 的统计，不从信号数量推算收益。" />
      <section className="dashboard-section">
        <div className="section-heading"><div><p className="eyebrow">Forward Review</p><h2>正式信号表现</h2></div></div>
        <ReviewMetricGrid metrics={overview.reviewMetrics} />
      </section>
      <section className="dashboard-section">
        <div className="section-heading"><div><p className="eyebrow">Research / Backtest</p><h2>研究 / 回测表现</h2></div></div>
